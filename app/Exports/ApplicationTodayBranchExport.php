...
class ApplicationTodayBranchExport extends DefaultValueBinder implements WithCustomCsvSettings, WithHeadings, FromQuery, WithCustomValueBinder
{
    use Exportable;

    public function __construct(string $yeuh, string $city)
    {
        $this->yeuh = $yeuh;
        $this->city = $city;
