...
class PemohonBranchExport extends DefaultValueBinder implements WithCustomCsvSettings, WithHeadings, FromQuery, WithCustomValueBinder
{
    ...
    {
        return PemohonModel::select('nik', 'tokenreg', 'name', 'email', 'no_hp', 'ip_address')
