...
class ApprovalBranchExport extends DefaultValueBinder implements WithCustomCsvSettings, WithHeadings, FromQuery, WithCustomValueBinder
{
    ...
    public function query()
    {
        return SubmittedData::select('tbl_log_request.request_code', 'username', 'host', 'param', 'data', 'tbl_log_request.service_name', 'tbl_log_request.insert_date')
            ...
            // ->where('status_by_cabang', 'Approve')
