...
class ApplicantGlobalController extends Controller
{
    //
    ...
    public function index(Request $request)
    {
        ...
        return view('globalapplicant.index', [
            'ref_no'    => 'Ref No',
            'applicant' => $applicant,
    ...
    public function show($ref_no = 0)
    {
        ...
        $globalapplicant = DB::table('applicant_stepfive')
        ...
        return view('globalapplicant.show', compact('globalapplicant','databank'));
    }

    public function printCreditApplicationForm($ref_no = 0){
