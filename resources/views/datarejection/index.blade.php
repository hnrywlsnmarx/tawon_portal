...
<div class="left-content">
    <h4 class="content-title mb-1">Negative Activity Log</h4>				
...
@section('content')
    ...
    <table class="table table-bordered table-hover mb-0 text-md-nowrap border" style="font-size: smaller;">
        ...
        <tr>
            ...
            <td>
                <a class="btn btn-sm btn-success" href="{{ route('negativeactivity.show',$score->nik) }}"style="margin-right: 30px">Show</a>
            </td>
        </tr>
        @endforeach
    </table>
