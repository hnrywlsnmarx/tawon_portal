...
<div class="left-content">
    ...
    <div class="pull-right mt-1">
        <a class="btn btn-sm btn-primary" href="{{ route('dbrusaha.index', $ref_no) }}"> Back</a>
    </div>	
</div>
...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-6 col-md-6">
            <form action="{{ route('dbrusaha.store') }}" method="POST">
                @csrf
                <div class="card">
                    <div class="card-body" style="font-size: smaller;">
                        ...
                        <div class="row row-xs align-items-center mg-b-7">
                            ...
                            <div class="col-md-8 mg-t-5 mg-md-t-0">
                                <input type="text" class="form-control form-control-sm" required readonly value="{{ $bidang_usaha }}" style="background-color: white; border: none;" name="bidang_usaha">
                            </div>
                        </div>
                        <div class="row row-xs align-items-center mg-b-7">
                            <div class="col-md-4">
                        ...
                        <div class="row row-xs align-items-center mg-b-7">
                            <div class="col-md-4">
                                <label class="form-label mg-b-0">Rata - rata Penghasilan Perbulan</label>
                            </div>
                            <div class="col-md-8 mg-t-3 mg-md-t-0">
                                <input type="text" class="form-control form-control-sm" required readonly value="{{ number_format($penghasilan_perbulan_number*$rate_number) }}" style="background-color: white; border: none;" name="av_penghasilan_perbulan">
                                {{-- <input type="text" class="form-control form-control-sm" required readonly value="{{ $penghasilan_perbulan_number }}" style="background-color: white; border: none;" name="penghasilan_perbulan_number"> --}}
                            </div>
                        </div>
                        <div class="row row-xs align-items-center mg-b-7">
                        ...
                        <div id="forhonor">
                            ...
                            {{-- <div class="row row-xs align-items-center mg-b-7">
                                ...
                                <div class="col-md-8 mg-t-3 mg-md-t-0">
                                    <select class="form-control form-control-sm" required style="width: 120;" name="credit_facility" id="credit_facility" onchange="resetField()">
                                        <option value="" selected="true">- Pilih Opsi -</option>
                            ...
                            <div class="row row-xs align-items-center mg-b-7">
                                ...
                                <div class="col-md-8 mg-t-3 mg-md-t-0">
                                    ...
                                    <input type="text" class="form-control form-control-sm" required  name="rate" id="rate" value="{{ $rate }}" readonly>
                                    <input type="hidden" class="form-control form-control-sm" required  name="rate_number" id="rate_number" value="{{ $rate_number }}" readonly>
                                    {{-- <input type="text" class="form-control form-control-sm" required readonly value="{{ $penghasilan_perbulan_number }}" style="background-color: white; border: none;" name="penghasilan_perbulan_number"> --}}
                                </div>
                            </div>
                            <div class="row row-xs align-items-center mg-b-7">
            ...
            <div class="card">
                <div class="card-body" style="font-size: smaller;">
                    ...
                    <table class="table table-bordered table-hover mb-0 text-md-nowrap border" style="font-size: smaller;">
                        ...
                        @foreach($dbr as $db)
                        <tr>
                            {{-- <td><input type="text" style="border: 0" name="id" id="id" value="{{ $db->id }}"></td> --}}
                            ...
                            <td>{{ $db->created_by }}</td>
                            <td>
                                <form action="{{ route('hapusdbrusaha',$db->id) }}" method="POST">
                                    <a class="btn btn-sm btn-warning" style="float: left;" href="{{ route('dbrusaha.edit', $db->id) }}">Edit</a>
                                    {{-- <a class="btn btn-sm btn-danger" style="float: right;" href="{{ route('dbrusaha.destroy', $db->id) }}">Delete</a> --}}
                                        @csrf
                                        @method('DELETE')
...
@if($dbracc == 0)
    <form action="{{ route('storeaccusaha') }}" method="POST">
        @csrf
@else
    <form action="{{ route('updateaccusaha', $ref_no) }}" method="POST">
        {{-- @method('PUT') --}}
        @csrf
@endif
<div class="row">
            ...
            <div class="card-body" style="font-size: smaller;">
                <div class="row row-xs align-items-center mg-b-7">
                    <button type="submit" class="btn btn-sm btn-danger mb-3"> Proceed Accumulation to Database</button>
                        ...
                        <input type="hidden" class="form-control form-control-sm" required readonly value="{{ $bidang_usaha }}" style="background-color: white; border: none;" name="bidang_usaha">
                <table class="table table-bordered table-hover" style="width: 100%; border-collapse: collapse;" border="0">
                    <tr style="background-color: rgb(207, 235, 250); font-weight: bolder;">
                        ...
                        <td>Rp <input type="text" style="background-color:rgb(207, 235, 250); border: none;" name="total_installment" value="{{ number_format($suminstallment) }}" required></td>
                    </tr>
                    <tr style="background-color:rgb(207, 235, 250); font-weight: bolder;">
                        <td style="border: none;" colspan="8"></td>
                        <td style="border: none;"></td>
                        ...
                        <td><input required type="text" style="background-color:rgb(207, 235, 250); border: none; width: 40px;" name="dbr_existing" value="{{ round(($suminstallment/($penghasilan_perbulan_number*$rate_number))*100, 2) }}">%</td>
                    </tr>
                    <tr style="background-color:rgb(207, 235, 250); font-weight: bolder;">
                        <td style="border: none;" colspan="8"></td>
                        <td style="border: none;"></td>
                        ...
                        <td><input type="text" style="background-color:rgb(207, 235, 250); border: none;" name="angsuran_kta" value="{{ $angsuran_perbulan }}" required></td>
                    </tr>
                    <tr style="background-color:rgb(207, 235, 250); font-weight: bolder;">
                        <td style="border: none;" colspan="8"></td>
                        <td style="border: none;"></td>
                        ...
                        <td><input required type="text" style="background-color:rgb(207, 235, 250); border: none; width: 40px;" name="new_dbr" value="{{ round(($suminstallment+$angsuran_perbulan_number)/($penghasilan_perbulan_number*$rate_number)*100, 2) }}">%</td>
                    </tr>
                    <tr style="background-color:rgb(207, 235, 250); font-weight: bolder;">
                        <td style="border: none;" colspan="8"></td>
                        <td style="border: none;"></td>
                        ...
                        <td><input required type="text" style="background-color:rgb(207, 235, 250); border: none; width: 40px;" name="dsr_kta" value="{{ round(($angsuran_perbulan_number/($penghasilan_perbulan_number*$rate_number))*100, 2) }}">%</td>
                    </tr>
                </table>
    ...
    function calculateDBR(){
        ...
        if(valSlik == ''){
            ...
            alert('Isi Maturity');
                ...
                const realRate = (valRate/100)/12;j
