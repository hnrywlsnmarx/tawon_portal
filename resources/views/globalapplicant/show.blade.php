...
@section('breadcrumb')
					<div class="left-content">
						<h4 class="content-title mb-1">Permohonan KTA Global</h4>
    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right">
                <a class="btn btn-sm btn-primary" href="{{ route('application-global.index') }}"> Back</a>
            </div>
        </div>
    </div>
    <br>
    <div class="row" style="font-size: smaller;">
        @foreach($globalapplicant as $glob)
