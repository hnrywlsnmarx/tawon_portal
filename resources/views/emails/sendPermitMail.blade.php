...
<body>
    ...
    <table style="width: 100%; height: 139px;" width="46" border="0">
        <tbody>
            ...
            <tr>
                <td style="width: 34%;">Jumlah Pengajuan Pinjaman</td>
                <td style="width: 10%;">:</td>
                <td style="width: 59%;">{{ $details['jumlah_pinjaman'] }}</td>
            </tr>
            <tr>
                <td style="width: 34%;">Jumlah Penyesuaian Pinjaman</td>
                <td style="width: 10%;">:</td>
                <td style="width: 59%;">{{ $details['adjustment_pinjaman'] }}</td>
            </tr>
            <tr>
                <td style="width: 34%;">Jangka Waktu</td>
                <td style="width: 10%;">:</td>
                <td style="width: 59%;">{{ $details['jangka_waktu'] }} bulan</td>
            </tr>
            <tr>
                <td style="width: 34%;">Angsuran Perbulan setelah Penyesuaian</td>
                <td style="width: 10%;">:</td>
                <td style="width: 59%;">{{ $details['angsuran_perbulan'] }}</td>
            </tr>
        </tbody>
    </table>
        <!-- DivTable.com -->
