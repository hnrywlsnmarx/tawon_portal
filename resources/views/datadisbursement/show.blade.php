...
<div class="left-content">				
    <h5 class="content-title mb-1">Data Disbursement</h5>					
    <nav aria-label="breadcrumb">					
        <ol class="breadcrumb">					
            <li class="breadcrumb-item"><a href="#">Data Disbursement</a></li>					
            <li class="breadcrumb-item active" aria-current="page">Show</li>					
        </ol>					
    </nav>			
    <div class="pull-right mt-1">
        <a class="btn btn-sm btn-primary" href="{{ route('datadisbursement.index') }}"> Back</a>
    </div>
</div>
                        ...
                        <div class="pd-30 pd-sm-40">
                            <div class="row row-xs align-items-center mg-b-0">
                                ...
                                <div class="col-md-8 mg-t-5 mg-md-t-0">
                                    <input type="text" required style="width: 150px; border: none;" id="nik" name="nik" readonly value="{{ $score->nik }}"> 
                                </div>
                            </div>
                            <hr>
                            <div class="row row-xs align-items-center mg-b-0">
                                ...
                                <div class="col-md-8 mg-t-5 mg-md-t-0">
                                    <input type="text" required style="width: 150px; border: none;" id="tokenreg" name="tokenreg" readonly value="{{ $score->tokenreg }}"> 
                                </div>
                            </div>
                            <hr>
                            <div class="row row-xs align-items-center mg-b-0">
                                ...
                                <div class="col-md-8 mg-t-5 mg-md-t-0">
                                    <input type="text" required style="width: 150px; border: none;" id="ref_no" name="ref_no" readonly value="{{ $score->ref_no }}"> 
                                </div>
                            </div>
                            <hr>
                            <div class="row row-xs align-items-center mg-b-0">
                                ...
                                <div class="col-md-8 mg-t-5 mg-md-t-0">
                                    <input type="text" required style="width: 150px; border: none;" id="produkkta" name="produkkta" readonly value="{{ $score->produkkta }}"> 
                                </div>
                            </div>
                            <hr>
                            <div class="row row-xs align-items-center mg-b-0">
                                ...
                                <div class="col-md-8 mg-t-5 mg-md-t-0">
                                    <input type="text" required style="width: 150px; border: none;" id="namapemohon" name="namapemohon" readonly value="{{ $score->namapemohon }}"> 
                                </div>
                            </div>
                            <hr>
                            <div class="row row-xs align-items-center mg-b-0">
                                ...
                                <div class="col-md-8 mg-t-5 mg-md-t-0">
                                    <input type="text" required style="width: 150px; border: none;" id="totalscore" name="totalscore" readonly value="{{ $score->totalscore }}"> 
                                </div>
                            </div>
                            <hr>
                            <div class="row row-xs align-items-center mg-b-5">
                                ...
                                <div class="col-md-8 mg-t-5 mg-md-t-0">
                                    <input type="text" required style="width: 180px; border: none;" id="status_by" name="status_by" readonly value="{{ $score->status_by_ho }}">
                                </div>
                            </div>
                            <hr>
                            <div class="row row-xs align-items-center mg-b-5">
                                ...
                                <div class="col-md-8 mg-t-5 mg-md-t-0">
                                    <input type="text" required style="width: 150px; border: none;" id="created_by" name="created_by" readonly value="{{ $score->created_by }}">
                                    <input type="hidden" required style="width: 150px; border: none;" id="updated_by" name="updated_by" readonly value="{{ session('nik') }}">
                                </div>
                            </div>
                            <hr>
                            <div class="row row-xs align-items-center mg-b-5">
                                <div class="col-md-3">
                                    <label class="form-label mg-b-0">Disbursed at</label>
                                </div>
                                <div class="col-md-8 mg-t-5 mg-md-t-0">
                                    <input type="text" required style="width: 150px; border: none;" id="created_by" name="created_by" readonly value="{{ $score->created_at }}">
                                    <input type="hidden" required style="width: 150px; border: none;" id="updated_by" name="updated_by" readonly value="{{ session('nik') }}">
                                </div>
                            </div>
                            <hr>
                            <div class="row row-xs align-items-center mg-b-5">
                                <div class="col-md-3">
                                    <label class="form-label mg-b-0">Disbursed By</label>
                                </div>
                                <div class="col-md-8 mg-t-5 mg-md-t-0">
                                    <input type="text" required style="width: 150px; border: none;" id="updated_by" name="updated_by" readonly value="{{ $updated_by }}">
                                </div>
                            </div>
                            <hr>
                        </div>
