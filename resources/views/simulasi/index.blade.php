...
<div class="left-content">
    <h4 class="content-title mb-1">Data Simulasi Hari ini</h4>				
    <nav aria-label="breadcrumb">					
        <ol class="breadcrumb">				
            <li class="breadcrumb-item"><a href="#">Simulasi Hari ini</a></li>					
...
@section('content')
    ...
    <table class="table table-bordered table-hover mb-0 text-md-nowrap border" style="font-size: smaller;">
        ...
        <tr>
            ...
            <td>
                <a class="btn btn-sm btn-success" href="{{ route('simulasi-today.show',$sims->nik) }}">Show</a>
            </td>
        </tr>
        @endforeach
    </table>
