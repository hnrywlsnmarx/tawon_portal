...
<div class="left-content">
    <h4 class="content-title mb-1">Data Requestor Link Registrasi KTA</h4>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#">Requestor Link Registrasi KTA</a></li>
...
@section('content')
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-left">
                <h4>Download Data Requestor Link Registrasi KTA</h4>
            </div>
        </div>
    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="pd-30 pd-sm-40 bg-gray-100">
                        <div class="input-group">                        
                            <div class="col-md-6">
                                From:&nbsp;<input class="from_date form-control" required type="text" name="from_date" id="from_date" onfocus="disbut();" onblur="disbuton();">
                                <input type="hidden" id="from_date_hid" name='from_date_hid' value="{{ request('from_date_hid') }}">
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                To:&nbsp;<input class="to_date form-control" required type="text" name="to_date" id="to_date" onblur="disbut();">
