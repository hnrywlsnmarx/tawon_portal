...
<link href="{{URL::asset('assets/plugins/bootstrap/css/bootstrap-datepicker.css')}}" rel="stylesheet" />
...
<!--- Color css-->
<link id="theme" href="{{URL::asset('assets/css/colors/color.css')}}" rel="stylesheet">
