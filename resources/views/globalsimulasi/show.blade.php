...
@section('breadcrumb')
					...
					<div class="left-content">
						<h4 class="content-title mb-1">Simulasi Global</h4>
...
@section('content')
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-left">
                <h2> Show Detail Simulasi Global</h2>
            </div>
            <div class="pull-right">
                <a class="btn btn-primary" href="{{ route('simulasi-global.index') }}"> Back</a>
            </div>
        </div>
    </div>
    <br>
    <div class="row">
        @foreach($globalsimulasi as $glob)
