...
<div class="left-content">
    <h4 class="content-title mb-1">Data Permohonan KTA Hari ini</h4>				
    <nav aria-label="breadcrumb">					
        <ol class="breadcrumb">				
            <li class="breadcrumb-item"><a href="#">Permohonan KTA Hari ini</a></li>					
...
@section('content')
    ...
    <div style="float: right;">
        <a href="appstoday/exportexcel" class="btn btn-sm btn-danger mt-2 mb-3" target="_blank">Download Excel</a>
        <a href="appstoday/exportcsv" class="btn btn-sm btn-info mt-2 mb-3" target="_blank">Download CSV</a>
    </div>
    ...
    <table class="table table-bordered table-hover mb-0 text-md-nowrap border" style="font-size: smaller;">
        ...
        <tr>
            ...
            <td>
                <a class="btn btn-sm btn-success" href="{{ route('application-today.show',$apps->ref_no) }}">Show</a>
            </td>
        </tr>
        @endforeach
    </table>
