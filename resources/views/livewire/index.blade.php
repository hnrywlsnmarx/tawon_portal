...
@section('breadcrumb')
					<div class="left-content">
						<h4 class="content-title mb-2">Hi, welcome back! {{  session('nik') }}</h4>
							...
							<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
								<div class="card">
									<div class="card-body iconfont text-left">
										<div class="d-flex justify-content-between">
											...
											<div class="card-options ml-auto">
												<div class="btn-group ml-5 mb-0">
													<a class="btn-link option-dots" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="#"><i class="fe fe-more-vertical tx-gray-500"></i></a>
													<div class="dropdown-menu dropdown-menu-right shadow">
														<a class="dropdown-item" href="#"><i class="fe fe-plus mr-2"></i>Add New</a>
														<a class="dropdown-item" href="#"><i class="fe fe-eye mr-2"></i>View all new tab</a>
														<a class="dropdown-item" href="#"><i class="fe fe-edit mr-2"></i>Edit Card</a>
										...
										<small class="mb-0 text-muted">Monthly<span class="float-right text-muted mg-t-2">70%</span></small>
									</div>
								</div>
							</div>
							<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
								<div class="card">
									<div class="card-body iconfont text-left">
										...
										<small class="mb-0  text-muted">Monthly<span class="float-right text-muted mg-t-2">50%</span></small>
									</div>
								</div>
							</div>
							<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
								<div class="card">
									<div class="card-body iconfont text-left">
										...
										<small class="mb-0  text-muted">Monthly<span class="float-right text-muted mg-t-2">60%</span></small>
									</div>
								</div>
							</div>
							<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
								<div class="card">
									<div class="card-body iconfont text-left">
										...
										<small class="mb-0  text-muted">Monthly<span class="float-right text-muted mg-t-2">40%</span></small>
									</div>
								</div>
							</div>
							<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
								<div class="card overflow-hidden">
									<div class="card-header bg-transparent pd-b-0 pd-t-30 bd-b-0">
										...
										<p class="tx-12 text-muted mb-0">session by country mean that the user is from the stated country or that the session. <a href="">Learn more</a></p>
									</div>
										...
										<div class="row row-sm">
											<div class="col-xl-7 col-lg-7 mx-auto d-block">
												<div class="progress mg-b-10 rounded-20">
													<div class="progress-bar ht-25 wd-50p bg-success tx-14" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100">Online Revenue</div>
													<div class="progress-bar ht-25 wd-50p bg-primary tx-14" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100">Offline Revenue</div>
												</div>
												<div class="row mb-0">
													<div class="col-6">
														<div class="media text-center">
															<div class="media-body">
																<h4 class="tx-22 font-weight-bold mb-1 ">13,375</h4><span><strong class="tx-success">10.5%</strong><span class="text-muted tx-12 ml-1"> of 20,000 Total</span></span>
															</div>
														</div>
													</div>
													<div class="col-6">
														<div class="media text-center">
															<div class="media-body">
																<h4 class="tx-22 font-weight-bold mb-1">16,625</h4><span><strong class="tx-danger">89.5%</strong><span class="text-muted tx-12 ml-1"> of 20,000 Total</span></span>
															</div>
														</div>
													</div>
												</div>
									...
									<div class="card-body pt-0">
										<div class="Analytics-chart-styles">
											...
											<div class="feature widget-2 text-center mt-0">
												<i class="ti-stats-up project bg-primary-transparent mx-auto text-primary mb-3"></i>
										...
										<div class="mg-t-0">
											<div class="row">
												<div class="col-6 text-center">
													<div class="mb-1 d-flex"><div class="ht-10 wd-20 bg-primary mt-1 mr-2 rounded-5"></div> Traveling</div>
												</div>
												<div class="col-6 text-center">
													<div class="mb-1 d-flex"><div class="ht-10 wd-20 bg-success mt-1 mr-2 rounded-5"></div> Pressentation</div>
												</div>
												<div class="col-6 text-center">
													<div class="mb-1 d-flex"><div class="ht-10 wd-20 bg-warning mt-1 mr-2 rounded-5"></div> Business</div>
												</div>
												<div class="col-6 text-center">
													<div class="mb-1 d-flex"><div class="ht-10 wd-20 bg-info mt-1 mr-2 rounded-5"></div> Others</div>
												</div>
											</div>
										</div>
									</div>
						...
						<div class="card">
							<div class="card-body pd-20">
								<div class="">
									...
									<h6 class="mg-t-20">Revenue <a class="text-right float-right tx-12 tx-gray-800" href="#">Details <i class="fas fa-angle-right"></i></a></h6>
									<h2 class="tx-40 mg-b-0">$32,89,098</h2>
									<p class="mb-2 tx-12 text-muted"><i class="fas fa-arrow-circle-down text-success"></i> Compared to Last week</p>
									<h6 class="mg-t-20">Current activity</h6>
									<div class="progress mg-b-10">
										<div class="progress-bar progress-bar-lg wd-30p bg-success" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100">30%</div>
										<div class="progress-bar progress-bar-lg wd-40p bg-primary" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100">40%</div>
										<div class="progress-bar progress-bar-lg wd-15p bg-info" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100">15%</div>
										<div class="progress-bar progress-bar-lg wd-15p bg-danger" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100">15%</div>
									</div>
									<div class="row row-sm mg-t-20">
										<div class="col">
											<div class="mb-1 d-flex"><div class="ht-10 wd-10 bg-success mt-1 mr-2 brround"></div>Sales</div>
										</div>
									...
									<div class="row row-sm mg-t-10">
										<div class="col">
											<div class="mb-1 d-flex"><div class="ht-10 wd-10 bg-primary mt-1 mr-2 brround"></div>Orders</div>
										</div>
										<div class="col col-auto">
									...
									<div class="row row-sm mg-t-10">
										<div class="col">
											<div class="mb-1 d-flex"><div class="ht-10 wd-10 bg-info mt-1 mr-2 brround"></div>products Sold</div>
										</div>
										<div class="col col-auto">
									...
									<div class="row row-sm mg-t-10">
										<div class="col">
											<div class="mb-1 d-flex"><div class="ht-10 wd-10 bg-danger mt-1 mr-2 brround"></div>Profit</div>
										</div>
										<div class="col col-auto">
							...
							<div class="card-body pd-20">
								<div class="">
									...
									<div class="d-flex mg-t-25">
										<div class="chart-circle chart-circle-sm ml-0 mr-3" data-value="0.65" data-thickness="10" data-color="#5066e0"><canvas width="140" height="140"></canvas>
											<div class="chart-circle-value"><div class="tx-14 font-weight-bold">65%</div></div>
										</div>
										<div class="mg-t-10">
									...
									<div class="d-flex mg-t-20">
										<div class="chart-circle chart-circle-sm ml-0 mr-3" data-value="0.65" data-thickness="10" data-color="#ff8c00"><canvas width="140" height="140"></canvas>
											<div class="chart-circle-value"><div class="tx-14 font-weight-bold">65%</div></div>
										</div>
										<div class="mg-t-10">
									...
									<div class="d-flex mg-t-20">
										<div class="chart-circle chart-circle-sm ml-0 mr-3" data-value="0.65" data-thickness="10" data-color="#00d48f"><canvas width="140" height="140"></canvas>
											<div class="chart-circle-value"><div class="tx-14 font-weight-bold">65%</div></div>
										</div>
										<div class="mg-t-10">
									...
									<a class="btn btn-light btn-block mg-t-20" href="#"><i class="fe fe-plus"></i> Add New Project</a>
								</div>
							</div>
						</div>
					</div>
							...
							<div class="card-body">
								<div class="table-responsive">
									<table id="example1" class="table table-striped table-bordered text-nowrap" style="width:100%">
										...
										<tbody>
											<tr>
												<td class="font-weight-bold"><div class="d-flex"><span class="avatar avatar-sm brround">S</span><span class="mg-l-10 mg-t-7">SREE Enrprices</span></div></td>
												<td>20,125</td>
												<td>10513.00</td>
												<td>Watch</td>
											...
											<tr>
												<td class="font-weight-bold"><div class="d-flex"><span class="avatar avatar-sm brround bg-success">G</span><span class="mg-l-10 mg-t-7">Granite Cake</span></div></td>
												<td>1,250,103</td>
												<td>425.25</td>
												<td>Medical</td>
											...
											<tr>
												<td class="font-weight-bold"><div class="d-flex"><span class="avatar avatar-sm brround bg-secondary">G</span><span class="mg-l-10 mg-t-7">GOODS Best</span></div></td>
												<td>425.25</td>
												<td>1.2029</td>
												<td>Cake</td>
											...
											<tr>
												<td class="font-weight-bold"><div class="d-flex"><span class="avatar avatar-sm brround bg-info">M</span><span class="mg-l-10 mg-t-7">Multi Shop</span></div></td>
												<td>28,470</td>
												<td>1547.67</td>
												<td>Elactronics</td>
											...
											<tr>
												<td class="font-weight-bold"><div class="d-flex"><span class="avatar avatar-sm brround bg-warning">S</span><span class="mg-l-10 mg-t-7">Sagar Limited</span></div></td>
												<td>24,983</td>
												<td>723.48</td>
												<td>Mobile</td>
											...
											<tr>
												<td class="font-weight-bold"><div class="d-flex"><span class="avatar avatar-sm brround bg-success">I</span><span class="mg-l-10 mg-t-7">Indo Allinone</span></div></td>
												<td>81,865</td>
												<td>149.18</td>
												<td>Fashion</td>
												<td class="font-weight-bold">$86,334</td>
											...
											<tr>
												<td class="font-weight-bold"><div class="d-flex"><span class="avatar avatar-sm brround bg-danger">S</span><span class="mg-l-10 mg-t-7">Spark Limited</span></div></td>
												<td>32,309</td>
												<td>149.18</td>
												<td>Gift</td>
