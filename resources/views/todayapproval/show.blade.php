...
<div class="left-content">				
    <h5 class="content-title mb-1">Today Approval & Rejection KTA</h5>					
    ...
    <div class="pull-right mt-1">
        <a class="btn btn-sm btn-primary" href="{{ route('todayapproval.index') }}"> Back</a>
    </div>
</div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="pd-30 pd-sm-40">
                        ...
                        <div class="row row-xs align-items-center mg-b-5">
                            <div class="col-md-3">
                                <label class="form-label mg-b-0">Scored By HO</label>
                            </div>
                            <div class="col-md-8 mg-t-5 mg-md-t-0">
                                {{ $score->created_by_ho }}
                            </div>
                        ...
                        <div class="row row-xs align-items-center mg-b-5">
                            ...
                            <div class="col-md-8 mg-t-5 mg-md-t-0">
                                {{ $score->status_by_cabang }}
                            </div>
                        </div>
                        <hr>
                        <div class="row row-xs align-items-center mg-b-5">
                            <div class="col-md-3">
                                <label class="form-label mg-b-0">Comment By Cabang</label>
                            </div>
                            <div class="col-md-8 mg-t-5 mg-md-t-0">
                                {{ $score->comment_by_cabang }}
                            </div>
                        </div>
                        <hr>
                        <div class="row row-xs align-items-center mg-b-5">
                            <div class="col-md-3">
                                <label class="form-label mg-b-0">Action By Cabang</label>
                            </div>
                            <div class="col-md-8 mg-t-5 mg-md-t-0">
                                {{ $score->created_by_cabang }}
                            </div>
                        </div>
                    </div>
                </div>
