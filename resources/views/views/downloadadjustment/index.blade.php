...
<div class="left-content">
    <h4 class="content-title mb-1">Data Penyesuaian Pinjaman KTA</h4>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#">Penyesuaian Pinjaman KTA</a></li>
...
@section('content')
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-left">
                <h4>Download Data Penyesuaian Pinjaman KTA</h4>
            </div>
        </div>
    </div>
