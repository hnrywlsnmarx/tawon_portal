...
@section('content')
                    ...
                    <div class="card-body">
                        <div class="pd-10 pd-sm-40 bg-gray-100">
                            <div class="input-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control form-control-sm" id="norek" name="norek" placeholder="No Rekening">
                                </div>
    ...
    <center>
       <p id="decis" style="font-size: large;background-color: darkcyan;color: rgb(255, 255, 255);"></p>
       <p id="decisgagal" style="font-size: large;background-color: rgb(158, 4, 4);color: rgb(255, 255, 255);"></p>
    </center>
    ...
    <script>
        function submitForm() {
            ...
            var apiUrl = "http://172.28.97.167:888//tawon_api/servicespayroll/";
            ...
            var data = JSON.stringify({ "norek": norek });
            xhr.send(data);
        }
    </script>
@endsection
