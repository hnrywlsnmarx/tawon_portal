...
<div class="left-content">				
    <h5 class="content-title mb-1">Disbursement</h5>					
    ...
    <div class="pull-right mt-1">
        <a class="btn btn-sm btn-primary" href="{{ route('disbursement.index') }}"> Back</a>
    </div>
</div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="pd-30 pd-sm-40">
                            ...
                            <div class="row row-xs align-items-center mg-b-0">
                                ...
                                <div class="col-md-8 mg-t-5 mg-md-t-0">
                                    <input type="text" required style="width: 150px; border: none;" id="kabupatenkota" name="kabupatenkota" readonly value="{{ $score->kabupatenkota }}"> 
                                </div>
                            </div>
                            <hr>
                            <div class="row row-xs align-items-center mg-b-0">
                        ...
                        <button type="submit" class="btn btn-sm btn-primary" style="float: right">Mark as Disbursed</button>
                    </div>
                </div>
            </form>
        </div>
