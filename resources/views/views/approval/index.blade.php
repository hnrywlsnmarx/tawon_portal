...
<div class="left-content">
    <h4 class="content-title mb-1">Data Approval</h4>				
...
@section('content')
    ...
    <table class="table table-bordered table-hover mb-0 text-md-nowrap border" style="font-size: smaller;">
        ...
        <tr>
            ...
            <td>
                <a class="btn btn-sm btn-success" href="{{ route('approval.show',$score->ref_no) }}"style="margin-right: 30px">Show</a>
                <a class="btn btn-sm btn-primary" href="{{ route('approve',$score->ref_no) }}" style="margin-right: 25px">Approve</a>
                <a class="btn btn-sm btn-danger" href="{{ route('reject',$score->ref_no) }}">Reject</a>
            </td>
        </tr>
        @endforeach
    </table>
