...
<div class="left-content">				
    <h5 class="content-title mb-1">Approve Pengajuan KTA</h5>					
    <nav aria-label="breadcrumb">					
        <ol class="breadcrumb">					
            <li class="breadcrumb-item"><a href="#">Approve Pengajuan KTA</a></li>					
...
@section('content')
    <div class="row" style="font-size: smaller;">
        @foreach($infobasic as $inbas)
        @endforeach
        {{-- <div class="col-lg-6 col-md-6">
            <div class="card">
                <div class="card-body">
                    <center><u style="font-weight: bolder;">Resume Data Nasabah</u></center>
                    <div class="pd-30 pd-sm-40">
                        <div class="row row-xs align-items-center mg-b-0">
                            ...
                            <div class="col-md-8 mg-t-5 mg-md-t-0">
                                <input type="text" required style="width: 150px; border: none; float: right;" id="nik" name="nik" readonly value="{{ $inbas->kk_stone }}"> 
                            </div>
                        </div>
                        <hr>
                        <div class="row row-xs align-items-center mg-b-0">
                            ...
                            <div class="col-md-8 mg-t-5 mg-md-t-0">
                                <input type="text" required style="width: 150px; border: none; float: right;" id="nik" name="nik" readonly value="{{ $inbas->npwp_stone }}"> 
                            </div>
                        </div>
                        <hr>
                        <div class="row row-xs align-items-center mg-b-0">
                            ...
                            <div class="col-md-8 mg-t-5 mg-md-t-0">
                                <input type="text" required style="width: 150px; border: none; float: right;" id="nik" name="nik" readonly value="{{ $inbas->no_hp }}"> 
                            </div>
                        </div>
                        <hr>
                        <div class="row row-xs align-items-center mg-b-0">
                            ...
                            <div class="col-md-8 mg-t-5 mg-md-t-0">
                                <input type="text" required style="width: 150px; border: none; float: right;" id="nik" name="nik" readonly value="{{ $inbas->mother_name }}"> 
                            </div>
                        </div>
                        <hr>
                        <div class="row row-xs align-items-center mg-b-0">
                            ...
                            <div class="col-md-8 mg-t-5 mg-md-t-0">
                                <input type="text" required style="width: 150px; border: none; float: right;" id="nik" name="nik" readonly value="{{ $inbas->tempat_lahir }}"> 
                            </div>
                        </div>
                        <hr>
                        <div class="row row-xs align-items-center mg-b-0">
                            ...
                            <div class="col-md-8 mg-t-5 mg-md-t-0">
                                <input type="text" required style="width: 150px; border: none; float: right;" id="nik" name="nik" readonly value="{{ $inbas->tgl_lahir }}"> 
                            </div>
                        </div>
                        <hr>
                        <div class="row row-xs align-items-center mg-b-0">
                            ...
                            <div class="col-md-8 mg-t-5 mg-md-t-0">
                                <input type="text" required style="width: 150px; border: none; float: right;" id="nik" name="nik" readonly value="{{ $inbas->marital_status }}"> 
                            </div>
                        </div>
                        <hr>
                    </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="pd-30 pd-sm-40">
                            ...
                            <div class="row row-xs align-items-center mg-b-0">
                                <div class="col-md-3">
                                    <label class="form-label mg-b-0">Nominal Penyesuaian Pinjaman</label>
                                </div>
                                <div class="col-md-8 mg-t-5 mg-md-t-0">
                                    <input type="text" required style="width: 150px; border: none; float: right;" id="adjustment_pinjaman" name="adjustment_pinjaman" readonly value="{{ $score->adjustment_pinjaman }}"> 
                                </div>
                            </div>
                            <hr>
                            <div class="row row-xs align-items-center mg-b-0">
                                <div class="col-md-3">
                                    <label class="form-label mg-b-0">Angsuran Perbulan setelah Adjusment</label>
                                </div>
                                <div class="col-md-8 mg-t-5 mg-md-t-0">
                                    <input type="text" required style="width: 150px; border: none; float: right;" id="angsuran_adjustment" name="angsuran_perbulan" readonly value="{{ $score->angsuran_adjustment }}"> 
                                </div>
                            </div>
                            <hr>
                            <div class="row row-xs align-items-center mg-b-0">
                            ...
                            <div class="row row-xs align-items-center mg-b-0">
                                ...
                                <div class="col-md-8 mg-t-5 mg-md-t-0">
                                    <input type="text" required style="width: 150px; border: none; float: right;" id="status_by_cabang" name="status_by_cabang" readonly value="Approve">
                                </div>
                            </div>
                            <hr>
                            <div class="row row-xs align-items-center mg-b-0">
                        ...
                        <button type="submit" class="btn btn-sm btn-primary" style="float: right">Approve</button>
                    </div>
                </div>
            </form>
        </div>
