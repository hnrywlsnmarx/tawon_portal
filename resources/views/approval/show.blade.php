                ...
                <div class="card-body">
                    ...
                    <div class="pd-30 pd-sm-40">
                        ...
                        <div class="row row-xs align-items-center mg-b-0">
                            ...
                            <div class="col-md-8 mg-t-5 mg-md-t-0">
                                <input type="text" required style="width: 150px; border: none; float: right;" id="angsuran_perbulan" name="angsuran_perbulan" readonly value="{{ $score->angsuran_adjustment }}"> 
                            </div>
                        </div>
                        <hr>
                        <div class="row row-xs align-items-center mg-b-0">
